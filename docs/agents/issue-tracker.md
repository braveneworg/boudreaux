...
- `.scratch/` is gitignored: tickets and specs are local working state, never
  committed and never pushed through the worktree/PR flow. Gitignoring also
  keeps Tailwind v4's automatic content detection from scanning scratch files.
