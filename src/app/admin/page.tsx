    ...
    <div>
      ...
      {/*
        ...
        artists[] (Should be an array of artist IDs associated with this release; can be multiple artists for collaborations),
          - name (Should be the full name of the artist; e.g., "Awesome Band" or "DJ Cool & Friends"),
          - firstName? (Should be the first name of the artist if applicable; e.g., "John"),
          - lastName? (Should be the last name of the artist if applicable; e.g., "Doe"),
          - relatedArtists[]? (Should be an array of artistIds that "Artists you might also like")
          - addedAt (Should be the date the artist was added to this release; typically set automatically),
          - bandcampProfileUrl? (Should be the URL to the Bandcamp page if applicable; e.g., "https://artist.bandcamp.com/album/album-name"),
          - fullBio
          - notes
          - shortBio
          - reviews[]? (Should be an array of review objects)
            - shortDescription
            - fullText
            - reviewedOn
            - source (Should be something like "New Haven Times")
            - reviewer
              - firstName
              - lastName
              - title
          - blueskyProfileUrl? (Should be the URL to https://bsky.app/profile/[handle], e.g., "https://bsky.app/profile/artist.bsky.social"),
          - instagramProfileUrl? (Should be the URL to the Instagram profile if applicable; e.g., "https://instagram.com/artist"),
          - primaryPictureUrl? (Should be the URL to the primary picture of the artist if applicable; e.g., "https://example.com/artist-picture.jpg"),
          - spotifyProfileURL? (Should be the URL to the Spotify page if applicable; e.g., "https://open.spotify.com/album/1A2B3C4D5E6F7G8H9I0J"),
          - websiteProfileUrl? (Should be the URL to the artist's official website if applicable; e.g., "https://artistwebsite.com"),
          ...
          - youtubeProfileMusicURL? (Should be the URL to the YouTube Music page if applicable; e.g., "https://music.youtube.com/playlist?list=PL1234567890ABCDEFGHIJ"),
        ...
        isSoldOut, (Should be a boolean indicating if the release is sold out; true or false),
        images[] (Should be an array of additional image URLs associated with the release; e.g., ["https://example.com/image1.jpg", "https://example.com/image2.jpg"]),
          - isCoverArt (boolean; indicates if the image is the cover art, because an album for example can have multiple images associated with it),
          - url (string; the URL of the image),
          - altText? (optional string; alt text for the image for accessibility),
        numberOfUnitsCreated, (Should be the number of units created for the release; e.g., 1000 aka the number of vinyls)
        ...
        websiteURL? (Should be the URL to a website URL for the album (probably a fake four url) if applicable; e.g., "https://albumwebsite.com"),
          */}
    </div>
  );
}
