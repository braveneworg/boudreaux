      ...
      <ContentContainer>
        ...
        <PageSectionParagraph>
          <Image
            ...
            className="shadow-zine-sm float-right ml-4 inline-block border-2 border-black"
            priority
          />
        ...
        <PageSection id="history" title="History">
          <PageSectionParagraph>
            ...
            Bernardino, California and Squids Eye Recording Collective in Dayton, Ohio as an outlet
            to release and distribute their personal music projects and those of their friends.
          </PageSectionParagraph>
          <PageSectionParagraph>
            <Link href="https://davidramos.bandcamp.com/album/this-up-here">
              <Image
                ...
                width={380}
                height={42}
                className="shadow-zine-sm float-left mr-4 mb-2 border-2 border-black"
              />
            </Link>
            The first full-length release came with <em>This Up Here</em> by David Ramos on May 20,
            2008. David Ramos, a co-founder of the label, was recognized by Modern Drummer magazine
            as one of the Top 10 Progressive drummers.
          </PageSectionParagraph>
          <PageSectionParagraph>
            In 2010, Fake Four Inc. became official label partners with Circle Into Square in
            Portland, Oregon, taking on production and distribution duties. The label is exclusively
            distributed by Sonic Unyon in Canada and Redeye Distribution worldwide.
          </PageSectionParagraph>
          <PageSectionParagraph>
            In 2013, a successful Indiegogo campaign raised over $52,000 to cover manufacturing
            costs and operating expenses, demonstrating the strong community support for the label.
          </PageSectionParagraph>
        </PageSection>

        <PageSection id="style-and-philosophy" title="Style & Philosophy">
          <PageSectionParagraph>
            Fake Four Inc. does not adhere to genre specifications, pushing the boundaries of indie
            rap and experimental music. Brett Uddenberg of URB magazine praised the label for its
            innovative approach to indie hip-hop.
          </PageSectionParagraph>
          <PageSectionParagraph>
            Chris Faraone of The Phoenix wrote:{' '}
            <em>
              &ldquo;you heard it here first: Fake Four is the most important label in progressive
              hip-hop right now.&rdquo;
            </em>
          </PageSectionParagraph>
          <PageSectionParagraph>
            The label has been noted for its intra-label collaborations, with artists signed to the
            label self-booking tours through the United States, Canada, and Europe.
          </PageSectionParagraph>
        </PageSection>
        ...
        <PageSection id="chart-success" title="Chart Success">
          <PageSectionParagraph>
            Nearly all releases on the label have placed on CMJ charts, including <em>Vessel</em> by
            Dark Time Sunshine which reached #2 on the CMJ Hip Hop ranking. This consistent chart
            performance demonstrates the label&apos;s ability to produce quality music that
            resonates with audiences and critics alike.
          </PageSectionParagraph>
        </PageSection>

        <PageSection id="recent-releases" title="Recent Releases">
          <PageSectionParagraph>
            The label continues to release innovative music, including anniversary reissues such as
            Blue Sky Black Death&apos;s <em>NOIR 10 Year Anniversary Reissue</em> and Ceschi&apos;s{' '}
            <em>They Hate Francisco False 15 Year Remastered Pressing</em>.
          </PageSectionParagraph>
        </PageSection>

        <PageSection id="community-and-impact" title="Community & Impact">
          <PageSectionParagraph>
            Since its inception, Fake Four Inc. has been a self-sufficient label, maintaining its
            independence while supporting a diverse roster of artists. The label represents more
            than just a business&mdash;it&apos;s a community of artists pushing the boundaries of
            underground hip-hop and experimental music.
          </PageSectionParagraph>
        </PageSection>
      </ContentContainer>
    </PageContainer>
