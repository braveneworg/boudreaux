      ...
      <ContentContainer>
        ...
        <ZinePanel accent="pink">
          ...
          <PageSection id="chart-success" title="Chart Success">
            <PageSectionParagraph>
              Nearly all releases on the label have placed on CMJ charts, including <em>Vessel</em>{' '}
              by Dark Time Sunshine which reached #2 on the CMJ Hip Hop ranking. This consistent
              chart performance demonstrates the label&apos;s ability to produce quality music that
