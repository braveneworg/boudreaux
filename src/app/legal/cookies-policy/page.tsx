      ...
      <ContentContainer>
        ...
        >
          ...
          <PageSectionParagraph>
            ...
            &ldquo;our&rdquo;) uses cookies and similar tracking technologies on our music streaming
            platform. This policy helps you understand what cookies are, how we use them, and your
          ...
          <PageSection id="what-are-cookies" title="What Are Cookies?">
            ...
            <ul className="list-inside list-disc space-y-2 text-zinc-700">
              ...
              <li>
                They have expiration dates (some expire when you close your browser, others persist
                longer)
              </li>
            </ul>
          </PageSection>
          ...
          <PageSection id="types-of-cookies" title="Types of Cookies We Use">
            ...
            <PageSectionParagraph>
              ...
              or by third-party providers whose services we use. If you do not allow these cookies,
            ...
            <ul className="list-inside list-disc space-y-2 text-zinc-700">
              ...
              <li>
                <strong>Playback cookies:</strong> Remember your listening history within a session
                to enable &ldquo;continue where you left off&rdquo; functionality
              </li>
              <li>
            ...
            <ul className="list-inside list-disc space-y-2 text-zinc-700">
              <li>
                <strong>Analytics cookies:</strong> Count visits, identify traffic sources, and see
            ...
            <PageSectionParagraph>
              <strong>Cookie Names:</strong> <code>_ga</code>, <code>_gid</code>, <code>_gat</code>{' '}
              (Google Analytics), <code>analytics_session</code>, <code>performance_tracking</code>
            </PageSectionParagraph>
            <PageSectionParagraph>
          ...
          <PageSection id="cookie-choices" title="Your Cookie Choices and Control">
            ...
            <PageSectionParagraph>
              Some browsers have a &ldquo;Do Not Track&rdquo; feature. When enabled, we respect this
              signal by:
            </PageSectionParagraph>
            <ul className="list-inside list-disc space-y-2 text-zinc-700">
          ...
          <PageSection id="eu-compliance" title="EU-Specific Rights and Compliance">
            ...
            <ul className="list-inside list-disc space-y-2 text-zinc-700">
              ...
              <li>
                <strong>Cookie Audit:</strong> We regularly review and audit all cookies used on our
                platform
              </li>
              <li>
              ...
              <li>
                <strong>Purpose Limitation:</strong> We only use cookie data for the purposes stated
                in this policy
              </li>
              <li>
              ...
              <li>
                <strong>No Cookie Walls:</strong> We do not deny access to our service if you reject
                non-essential cookies (though some features may be limited)
              </li>
            </ul>

            <h3 className="mt-6 mb-4 text-xl font-semibold">International Data Transfers</h3>
            <PageSectionParagraph>
              Some of our service providers (like Google Analytics) may transfer cookie data outside
              ...
              <table className="min-w-full border-collapse border border-zinc-300">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="border border-zinc-300 px-4 py-2">Google Analytics tracking</td>
