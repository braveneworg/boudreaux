    ...
    <PageContainer>
      <ContentContainer>
        ...
        >
          ...
          <PageSectionParagraph>
            Welcome to our music platform. By accessing or using this web application, you agree to
          ...
          <PageSection id="acceptance" title="1. Acceptance of Terms">
            <PageSectionParagraph>
              ...
              read, understood, and agree to be bound by these Terms and Conditions and our Privacy
              Policy. If you do not agree, you may not use this service.
            </PageSectionParagraph>
          </PageSection>
          ...
          <PageSection id="eligibility" title="2. Eligibility">
            <PageSectionParagraph>
              ...
              18, you must have your parent or legal guardian&apos;s permission to use this service.
          ...
          <PageSection id="acceptable-use" title="4. Acceptable Use">
            ...
            <ul className="list-inside list-disc space-y-2 text-zinc-700">
              ...
              <li>
                Distribute viruses, malware, or any other technologies that may harm the service or
                other users
              </li>
              <li>
          ...
          <PageSection id="content-ownership" title="5. Content Ownership and Licensing">
            ...
            <PageSectionParagraph>
              ...
              artists (collectively, &ldquo;Platform Content&rdquo;) is owned by us, our licensors,
              or the respective artists. Platform Content is protected by copyright, trademark, and
          ...
          <PageSection id="copyright-dmca" title="6. Copyright and DMCA">
            <PageSectionParagraph>
              ...
              If you believe your copyrighted work has been infringed, please contact our designated
          ...
          <PageSection id="content-moderation" title="8. Content Moderation">
            <PageSectionParagraph>
              We reserve the right, but have no obligation, to monitor, review, edit, or remove any
              User Content at our sole discretion, at any time and for any reason, without notice.
          ...
          <PageSection id="privacy-data" title="9. Privacy and Data">
            <PageSectionParagraph>
              ...
              protect your personal information as described in that policy. By using this service,
          ...
          <PageSection id="limitation-liability" title="14. Limitation of Liability">
            ...
            <PageSectionParagraph>
              ...
              TO THE EVENT GIVING RISE TO LIABILITY, OR ONE HUNDRED DOLLARS ($100), WHICHEVER IS
              GREATER.
            </PageSectionParagraph>
          </PageSection>
          ...
          <PageSection id="indemnification" title="15. Indemnification">
            <PageSectionParagraph>
              ...
              contractors, agents, and representatives from and against any claims, liabilities,
          ...
          <PageSection id="geographic-restrictions" title="16. Geographic Restrictions">
            <PageSectionParagraph>
              ...
              the United States, you are responsible for compliance with local laws. We make no
              representation that content available on the service is appropriate or available in
              other locations.
            </PageSectionParagraph>
          </PageSection>
          ...
          <PageSection id="changes-terms" title="17. Changes to Terms">
            <PageSectionParagraph>
              ...
              material changes by posting the new Terms on the service and updating the &ldquo;Last
              Updated&rdquo; date. Your continued use of the service after changes become effective
          ...
          <PageSectionParagraph className="text-sm italic">
            This Terms and Conditions document was last updated on November 4, 2025 and is effective
            immediately.
          </PageSectionParagraph>
        </ZinePanel>
      </ContentContainer>
