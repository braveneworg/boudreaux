        ...
        <ZinePanel accent="kraft">
          ...
          <PageSection id="information-we-collect" title="1. Information We Collect">
            ...
            <ul className="list-inside list-disc space-y-2 text-zinc-700">
              ...
              <li>
                These help us remember your preferences, keep you logged in, and understand how you
                use our service
              </li>
          ...
          <PageSection id="information-sharing" title="3. Information Sharing and Disclosure">
            <PageSectionParagraph>
              <strong>
                We do not sell your personal information. We do not rent your personal information.
                We do not share your personal information for third-party marketing purposes.
              </strong>
            </PageSectionParagraph>
            <PageSectionParagraph>
            ...
            <PageSectionParagraph>
              ...
              be transferred. We will notify you before your information is transferred and becomes
              subject to a different privacy policy.
            </PageSectionParagraph>

            <h3 className="mt-6 mb-4 text-xl font-semibold">Aggregated and Anonymized Data</h3>
            <PageSectionParagraph>
              We may share aggregated or anonymized information that cannot identify you personally,
              such as:
            </PageSectionParagraph>
            <ul className="list-inside list-disc space-y-2 text-zinc-700">
          ...
          <PageSection id="privacy-rights" title="4. Your Privacy Rights and Choices">
            ...
            <ul className="list-inside list-disc space-y-2 text-zinc-700">
              <li>
                Opt out of promotional emails while still receiving essential service notifications
              </li>
          ...
          <PageSection id="data-retention" title="6. Data Retention">
            ...
            <ul className="list-inside list-disc space-y-2 text-zinc-700">
              ...
              <li>
                ...
                legal obligations (e.g., payment records for tax purposes)
              </li>
              <li>
                <strong>Backup systems:</strong> Data in backup systems is deleted according to our
          ...
          <PageSection id="international-transfers" title="8. International Data Transfers">
            <PageSectionParagraph>
              Our service is operated from the United States. If you access our service from outside
              the United States, your information will be transferred to, stored, and processed in
              the United States. By using our service, you consent to this transfer.
            </PageSectionParagraph>
            <PageSectionParagraph>
          ...
          <PageSection id="summary" title="Summary: Our Privacy Promise">
            <ul className="list-inside space-y-2 text-zinc-700">
              ...
              <li>
                <strong>We keep your data secure.</strong> Industry-standard encryption and security
                practices protect your information.
              </li>
              <li>
