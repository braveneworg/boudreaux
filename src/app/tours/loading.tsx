  ...
  return (
    <div className="container mx-auto py-8">
      <div className="mb-8 space-y-2">
        <div className="bg-muted h-10 w-48 animate-pulse" />
        <div className="bg-muted h-6 w-96 animate-pulse" />
      </div>

      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {skeletonCards.map((card) => (
          <div key={`tour-skeleton-${card}`} className="bg-card overflow-hidden border">
            {/* Image skeleton */}
            ...
            <div className="space-y-4 p-6">
              ...
              <div className="space-y-2">
                ...
                <div className="bg-muted h-4 w-4/6 animate-pulse" />
              </div>

              <div className="flex gap-2 pt-2">
                <div className="bg-muted h-10 flex-1 animate-pulse" />
                <div className="bg-muted h-10 flex-1 animate-pulse" />
              </div>
            </div>
          </div>
