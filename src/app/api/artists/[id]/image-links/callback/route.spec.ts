...
import type { ImageLinksCallback } from '@/lib/validation/image-links-schema';
...
const validBody: ImageLinksCallback = {
  jobToken: 'stored-token',
  result: { ok: true, data: { images: [] } },
};

const buildRequest = (body: string): NextRequest =>
  new NextRequest(`http://localhost:3000/api/artists/${ARTIST_ID}/image-links/callback`, {
    method: 'POST',
...
describe('POST /api/artists/[id]/image-links/callback', () => {
