...
vi.mock('@/hooks/queries/use-release-user-status-query', () => ({
...
vi.mock('@/hooks/queries/use-release-digital-formats-query', () => ({
...
vi.mock('@/hooks/queries/use-release-related-query', () => ({
