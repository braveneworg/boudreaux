...
export const DownloadAnalyticsDashboard = ({ releaseId }: DownloadAnalyticsDashboardProps) => {
  ...
  return (
    <div className="space-y-4" data-testid="download-analytics-dashboard">
      ...
      {isLoading ? (
        <div className="py-8 text-center text-sm text-zinc-950" data-testid="loading">
          Loading analytics...
        </div>
      ) : !analytics ? (
        <div className="py-8 text-center text-sm text-zinc-950" data-testid="error">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                ...
                <BarChart3 className="h-4 w-4 text-zinc-950" />
              </CardHeader>
              <CardContent>
