...
const SheetContent = ({
  ...
  <SheetPortal>
    <SheetPrimitive.Content
      ...
      className={cn(
        'bg-background data-[state=open]:animate-in data-[state=closed]:animate-out shadow-zine-ink fixed z-50 flex flex-col gap-4 border-black transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500',
        side === 'right' &&
          'data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right top-0 right-0 bottom-0 h-full w-3/4 border-l-2 sm:max-w-sm',
        side === 'left' &&
