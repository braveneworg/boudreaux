 ...
 * Two decorative zinc-950 frames — each inset asymmetrically, tilted and
 * skewed its own way — sketch a hand-drawn double border that never quite
 * lines up with the strip's edge.
 */
