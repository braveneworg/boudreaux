...
export const ZineHeading = ({
  ...
  <Heading level={level} className={cn('mt-1 mb-4 h-auto', className)} {...props}>
    ...
    <span
      ...
      className="font-fake-four-cutout shadow-zine-ink inline-block -rotate-1 border-2 border-black bg-[var(--card-accent-soft)] px-3 py-1 text-3xl tracking-wide text-black uppercase sm:text-4xl"
    >
      {children}
    </span>
  </Heading>
