...
export default function HamburgerMenuSheet({
  ...
  return (
    <Sheet open={isOpen} onOpenChange={onOpenChange}>
      ...
      <SheetContent
        side="right"
        className="w-[100vw] top-[66.5px] border-0 z-[200] pt-0 px-8 absolute bg-transparent backdrop-blur before:inset-0 bg-[url(/media/particles-4.svg)] bg-cover bg-center opacity-95 bg-no-repeat z-10"
