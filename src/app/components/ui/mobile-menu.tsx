        ...
        {menuItems.map((item, index) => (
          ...
          >
            <Link
              ...
              className={cn(
                'mt-4 block text-xl tracking-wider text-zinc-50 underline-offset-8 transition-all duration-300 text-shadow-sm focus:outline-none focus-visible:rounded-md focus-visible:ring-2 focus-visible:ring-white aria-[current=page]:underline',
                item.color
              )}
              onClick={onNavigate}
              prefetch={false}
