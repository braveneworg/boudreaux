    ...
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: cn(
          ...
          captionLayout === 'label'
            ? 'text-sm'
            : 'pl-2 pr-1 flex items-center gap-1 text-sm h-8 [&>svg]:text-zinc-950 [&>svg]:size-3.5',
          defaultClassNames.caption_label
        ),
        table: 'w-full border-collapse',
        weekdays: cn('flex', defaultClassNames.weekdays),
        weekday: cn(
          'text-zinc-950 flex-1 font-normal text-[0.8rem] select-none',
        ...
        today: cn('bg-accent text-accent-foreground rounded-none', defaultClassNames.today),
