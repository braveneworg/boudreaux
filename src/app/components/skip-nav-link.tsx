...
export const SkipNavLink = () => (
  <a
    ...
    className="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 focus:z-200 focus:bg-zinc-50 focus:px-4 focus:py-2 focus:font-semibold focus:text-zinc-950 focus:shadow-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-zinc-950"
  >
