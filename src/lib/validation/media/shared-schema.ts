...
export const artistScalarSchema = z.object({
  ...
  imageLinksStatus: nullableString,
  imageLinksError: nullableString,
  imageLinksStartedAt: nullableDate,
  imageLinksJobToken: nullableString,
  imageLinksAddedCount: z.number().nullable(),
  slug: z.string(),
