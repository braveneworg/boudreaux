...
export const notificationBannerBaseSchema = z.object({
  message: z
    .string()
  ...
  imageUrl: z
    ...
    .optional()
    .or(z.literal('')),
  linkUrl: z.string().url({ message: 'Link URL must be a valid URL' }).optional().or(z.literal('')),
  backgroundColor: z
    .string()
...
export const notificationBannerSchema = notificationBannerBaseSchema.refine(
  (data) => {
