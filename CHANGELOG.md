...
- docs(lessons): 📝 commit WIP on-branch, not stash (#778)
- refactor(lambda): ♻️ share dispatch helpers (#775)

## [4.354.0] - 2026-09-26

### Changed

- perf(tests): ⚡ happy-dom everywhere, lazy icons, CI-only shell specs (#776)

## [4.353.0] - 2026-09-26

### Fixed

- fix(bio): 🐛 report links blocked by bot walls (#777)

## [4.352.0] - 2026-09-26

### Added

- feat(admin): ✨ image-source links feed the artist image pool (#772)
...
- feat(videos): ✨ punk-zine sort toggle and poster-aligned search (#768)

## [4.349.0] - 2026-09-22

### Fixed

- fix(admin): 🐛 keep the bio image pool from vanishing under an nginx 429 (#764)

## [4.348.0] - 2026-09-21

### Added

- feat(artists): ✨ edit genres and tags as pills (#763)

## [4.347.0] - 2026-09-21

### Fixed

- fix(artists): 🐛 curated genres survive bio regeneration (#762)

## [4.346.0] - 2026-09-21

### Changed

- refactor(ui): ♻️ share one removable pill (#761)

## [4.345.0] - 2026-09-21

### Changed

- test(playlists): ✅ fix the save-dialog Escape race flaking CI (#760)

## [4.344.0] - 2026-09-21

### Added

- feat(home): ✨ rebuild the homepage search as a zine combobox (#758)

## [4.343.0] - 2026-09-21

### Added

- feat(search): ✨ one punk-zine look for every public search (#757)

## [4.342.0] - 2026-09-20

### Added

- feat(artists): ✨ one photo per card on the artists index (#756)

## [4.341.0] - 2026-09-20

### Changed

- refactor(artists): ♻️ rework the artist card, and fold the bio into the artist page (#755)

## [4.340.0] - 2026-09-20

### Fixed

- fix(artists): 🐛 match search word by word (#754)
...
- fix(forms): 🐛 plus adds a display image (#750)

## [4.337.0] - 2026-09-18

### Added

- feat(artists): ✨ display images — choose or upload the artist page photos (#749)

## [4.336.0] - 2026-09-17

### Fixed

- fix(breadcrumbs): 🐛 drop the duplicate Home crumb on artist and playlist pages (#747)

## [4.335.0] - 2026-09-17

### Added

- feat(artists): ✨ inline search, richer cards, and the listed-artist rule on /artists (#746)

## [4.334.0] - 2026-09-15

### Added

- feat(artists): ✨ show featured and band releases (#745)

## [4.333.0] - 2026-09-14

### Added

- feat(video): ✨ one description editor, sourced only from enrichment (#744)

## [4.332.0] - 2026-09-14

### Added

- feat(video): ✨ never guess the release date; auto-lookup + autosave (#743)

## [4.331.0] - 2026-09-14

### Changed

- test: ✅ freeze clock in stale-job boundary test (#742)

## [4.330.0] - 2026-09-13

### Changed

- chore: 🔧 copy env files into worktrees; deny env reads (#741)

## [4.329.0] - 2026-09-13

### Fixed

- fix(ui): 🐛 seed chart size before first measure (#740)

## [4.328.0] - 2026-09-13

### Fixed

- fix(redis): 🐛 survive a lost Upstash database (#739)

## [4.327.0] - 2026-09-13

### Fixed

- fix(playlists): 🐛 embedded Save playlist submits (#738)

## [4.326.0] - 2026-09-13

### Fixed

- fix(playlists): 🐛 video thumbs + dialog overflow (#737)

## [4.325.0] - 2026-09-13

### Fixed

- fix(player): 🐛 no page flicker on playlist kebab (#736)

## [4.324.0] - 2026-09-12

### Changed

- ci(nginx): 👷 run nginx -t on every PR (#735)

## [4.323.0] - 2026-09-12

### Added

- feat(auth): ✨ gate every sign-in method on the Turnstile challenge, server-enforced (#734)

## [4.322.0] - 2026-09-12

### Fixed

- fix(nginx): 🐛 free the OAuth callback from the strict auth rate zone (#733)

## [4.321.0] - 2026-09-12

### Fixed

- fix(deps): 🐛 clear 35 dependabot alerts (#731)

## [4.320.0] - 2026-09-12

### Fixed

- fix(video): a replacement file drops any poster (#730)

## [4.319.0] - 2026-09-12

### Changed

- chore(deps): 🔧 minors, better-auth 1.7, vite 8 (#729)

## [4.318.0] - 2026-09-11

### Changed

- chore(deps): 🔧 patch-level dependency upgrades (#728)

## [4.317.0] - 2026-09-11

### Fixed

- fix(video): poster follows a replaced file (#705, #706) (#727)

## [4.316.0] - 2026-09-10

### Changed

- chore(tooling): 🔧 replace nvm and corepack with mise.toml (#726)

## [4.315.0] - 2026-08-09

### Fixed

- fix(releases): 🐛 blurb schema voided results (#725)

## [4.314.0] - 2026-08-09

### Added

- feat(releases): ✨ blurb generated from label notes (#724)

## [4.313.0] - 2026-08-09

### Fixed

- fix(video): 🐛 truncate overlong Gemini output instead of rejecting (#721)

## [4.312.0] - 2026-08-09

### Added

- feat(releases): ✨ AI-generate release notes in admin (#723)

## [4.311.0] - 2026-08-09

### Added

- feat(releases): ✨ show release notes in listing rows (#722)

## [4.310.0] - 2026-08-08

### Added

- feat(releases): ✨ page redesign — rows + play modal (#720)

## [4.309.0] - 2026-08-08

### Added

- feat(video): ✨ autogenerate ~500-char video descriptions with quotes (#719)

## [4.308.0] - 2026-08-08

### Added

- feat(video): ✨ video search becomes a suggestions combobox (#718)

## [4.307.0] - 2026-08-08

### Changed

- chore(prisma): 🔧 adopt prisma.config.ts on 6.x (#717)

## [4.306.0] - 2026-08-08

### Fixed

- fix(video): 🐛 start playback inside the click gesture (#715)

## [4.305.0] - 2026-08-08

### Fixed

- fix(deps): 🐛 clear hono advisories, drop deprecated crypto-js (#716)

## [4.304.0] - 2026-08-08

### Added

- feat(video): ✨ make the videos section public — no sign-in required (#714)

## [4.303.0] - 2026-08-08

### Fixed

- fix(video): 🐛 never overlay a poster image in the enlarged play modal (#713)

## [4.302.0] - 2026-08-08

### Fixed

- fix(deps): 🐛 patch 13 Dependabot advisories across all three lockfiles (#712)

## [4.301.0] - 2026-08-07

### Fixed

- fix(video): 🐛 pause primed media element to unstick the poster overlay (#711)

## [4.300.0] - 2026-08-07

### Fixed

- fix(audio): 🐛 recreate the vjs container per init (#710)

## [4.299.0] - 2026-08-07

### Added

- feat(video): ✨ redesign /videos with poster rows, modal player, search (#709)

## [4.298.0] - 2026-08-06

### Fixed

- fix(video): 🐛 play video on first click of the play button (#708)

## [4.297.0] - 2026-08-06

### Fixed

- fix(video): 🐛 stop release date re-apply loop (#707)

## [4.296.0] - 2026-08-04

### Added

- feat(video): ✨ persist poster candidates at upload (#704)

## [4.295.0] - 2026-08-04

### Added

- feat(artist): ✨ hard delete with cascade + admin confirm (#703)

## [4.294.0] - 2026-08-03

### Fixed

- fix(video): 🐛 delete cascade for video join rows (#702)

## [4.293.0] - 2026-08-02

### Fixed

- fix(deps): 🐛 patch brace-expansion DoS (GHSA-mh99) (#701)

## [4.292.0] - 2026-08-02

### Added

- feat(ui): 🎨 full border on zine panel (#700)

## [4.291.0] - 2026-07-26

### Fixed

- fix(video): 🐛 never fill release date from the video file (#699)

## [4.290.0] - 2026-07-26

### Fixed

- fix(video): 🐛 collapse dismissed enrichment descriptions (#698)

## [4.289.0] - 2026-07-26

### Fixed

- fix(deps): clear postcss alerts in lambda lockfiles (#697)

## [4.288.0] - 2026-07-24

### Fixed

- fix(deps): 🐛 clear 21 dependabot alerts (#696)

## [4.287.0] - 2026-07-24

### Fixed

- fix(search): prefetch combobox shape for /artists/search (#695)

## [4.286.0] - 2026-07-24

### Changed

- refactor: ♻️ honest ArtistDetail on findById (#694)

## [4.285.0] - 2026-07-24

### Added

- feat(video): ✨ enrichment date overrides upload fill (#693)

## [4.284.0] - 2026-07-24

### Added

- feat(video): ✨ enrichment date + editable description (#692)

## [4.283.0] - 2026-07-24

### Fixed

- fix(deploy): 🐛 strip newlines from key secrets (#689)

## [4.282.0] - 2026-07-24

### Changed

- docs: 📝 trim derivable structure tree (#690)

## [4.281.0] - 2026-07-24

### Fixed

- fix(s3): 🐛 log CloudFront key diagnostic fields (#688)

## [4.280.0] - 2026-07-24

### Changed

- refactor(hooks): move query hooks to queries/ (#687)

## [4.279.0] - 2026-07-23

### Fixed

- fix(s3): validate the CloudFront private key actually parses (#686)

## [4.278.0] - 2026-07-23

### Fixed

- fix(bio): log the YouTube API's full error message (#685)

## [4.277.0] - 2026-07-23

### Fixed

- fix(s3): harden CloudFront private-key resolution (diagnose + tolerate) (#684)

## [4.276.0] - 2026-07-23

### Fixed

- fix(bio): trim stored SSM keys and log the YouTube rejection reason (#683)

## [4.275.0] - 2026-07-23

### Added

- feat(video): find release dates from the video's YouTube upload (#682)

## [4.274.0] - 2026-07-23

### Added

- feat(video): auto-fill the release date on upload (#681)
...
- fix(download): serialize freemium quota check-and-charge per subject (#676)

## [4.271.0] - 2026-07-22

### Fixed

- fix(auth): require verification for guest-checkout downloads (#675)

## [4.270.0] - 2026-07-22

### Fixed

- fix(download): gate free single-format downloads to lossy formats (#674)

## [4.269.0] - 2026-07-22

### Fixed

- fix(download): cap free-only bundle downloads server-side (#673)

## [4.268.0] - 2026-07-22

### Fixed

- fix(auth): gate banned users in decorators (#672)

## [4.267.0] - 2026-07-22

### Changed

- refactor(repos): ♻️ extract bio-media repos (#671)

## [4.266.0] - 2026-07-22

### Changed

- refactor(schemas): ♻️ per-entity media schemas (#670)

## [4.265.0] - 2026-07-22

### Changed

- refactor(jobs): ♻️ one async-job lifecycle module (#662)

## [4.264.0] - 2026-07-22

### Changed

- refactor(schemas): ♻️ close drift-guard gaps (#660)

## [4.263.0] - 2026-07-22

### Changed

- refactor(artist): ♻️ honest read-path types (#658)

## [4.262.0] - 2026-07-22

### Changed

- refactor(video): ♻️ collapse duplicated facts (#657)

## [4.261.0] - 2026-07-22

### Fixed

- fix(video): 🐛 gate enrichment on one predicate (#656)

## [4.260.0] - 2026-07-21

### Changed

- docs: 📝 switch issue tracker to GitHub Issues (#647)

## [4.259.0] - 2026-07-21

### Changed

- docs: 📝 add agent skills config (#646)

## [4.258.0] - 2026-07-21

### Changed

- chore: 🔧 untrack generated architecture docs (#645)
